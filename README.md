...
1. Download `RehearsalPlayer-1.0.2.zip`.
...
- `RehearsalPlayer-1.0.2.zip`: installable plugin package
- `RehearsalPlayer-1.0.2.sha1`: SHA1 checksum for LMS repository installs
...
3. Create GitHub release tag `v1.0.2`.
4. Upload:
