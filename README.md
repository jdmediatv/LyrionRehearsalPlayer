...
Native Lyrion Music Server plugin for rehearsal spaces, with playlist artwork selection, tile-based track launching, metadata filters, large transport controls, player volume control, and (as of 1.1.4) a Spotify-backed teacher playlist section.
...
1. Download `RehearsalPlayer-1.1.4.zip`.
...
- `RehearsalPlayer-1.1.4.zip`: installable plugin package
- `RehearsalPlayer-1.1.4.sha1`: SHA1 checksum for LMS repository installs
...
3. Create GitHub release tag `v1.1.4`.
4. Upload:
